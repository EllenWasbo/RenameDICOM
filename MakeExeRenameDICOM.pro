...
;
;sett=CREATE_STRUCT('selDefault',0,'defPath',defPath,'tempElements',tempElements,'tagGroups',tagGroups,'tagElements',tagElements)
;temp0=CREATE_STRUCT('name','default','catElem',[0,1,2],'fileElem',[8,9], 'formats', ['(i04)','(i05)','(a0)','(a0)','(i0)','(i0)','(f0.1)','(a0)','(i04)','(f0.1)','(i0)','(i6)','(_\_\f0.1)'])
;structTemp=CREATE_STRUCT('settings',sett,'T0',temp0)
;;
